...
import { MoveRight, Puzzle, Search as SearchIcon } from 'lucide-react';
...
export function Component() {
  ...
  const data_favorites = surat.filter((navItem) =>
    selectedIds.includes(navItem.number)
  );
  console.warn(
    'DEBUGPRINT[5]: quran.index.tsx:81: data_favorites=',
    data_favorites,
  );
