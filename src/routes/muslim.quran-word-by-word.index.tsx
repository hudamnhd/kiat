...
import { Search as SearchIcon, MoveRight } from "lucide-react";
			...
			<SearchHandler
				...
				render={(filteredData) => {
					if (filteredData.length > 0) {
						...
						return (
							<div className="py-6 text-center text-sm h-[calc(100vh-240px)] border-b flex items-center justify-center">
...
const LastRead = () => {
	...
	return (
		<div className="p-3 border-b flex items-center gap-x-3 bg-background w-full">
			<p className="text-sm text-center mx-auto">Susun ayat quran, Yuk!</p>
		</div>
	);
