...
/**
 * Information manzilPages
 * s: start page;
 * e: end page;
 *
 * Manzil bahasa Arab: منزل adalah sebuah sistem pembagian pembacaan Al-Qur'an
 * untuk memudahkan penyelesaian (pengkhataman) Al-Qur'an selama tujuh hari (seminggu)
 */

export const manzilPages = [
  { s: 1 },
  { s: 221 },
  { s: 332 },
  { s: 415 },
